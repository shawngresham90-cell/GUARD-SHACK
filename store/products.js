...
const PRODUCTS = [
  ...
  /* ---------- MERCH — fulfill per-order via Printful ----------
     Lineup mirrors Printful's proven best-selling blanks; the exact
     blank + design brief for each item is in PRINTFUL-PLAYBOOK.md. */
  {
    id: "merch-trucker-cap",
    type: "direct",
    name: "Road Dog Trucker Cap — Richardson 112",
    price: 29.99,
    compareAt: 36.99,
    category: "Merch",
    emoji: "🧢",
    badge: "Best Seller",
    desc: "The Richardson 112 — the cap half the drivers at the fuel island are already wearing, with the Road Dog patch up front. Mesh back, snapback, curved bill. One size fits most.",
  },
  {
    id: "merch-tee-hammer",
    type: "direct",
    name: "\"Hammer Down\" Garment-Dyed Heavyweight Tee",
    price: 28.99,
    category: "Merch",
    emoji: "👕",
    badge: "New",
    desc: "Comfort Colors 1717 — thick, garment-dyed, gets better with every wash. Bold HAMMER DOWN back print, small chest logo. S–3XL.",
  },
  {
    id: "merch-hoodie",
    type: "direct",
    ...
    category: "Merch",
    emoji: "🥷",
    desc: "Heavy-blend fleece for dock waits and cold starts. Kangaroo pocket fits a logbook. Back print visible across the lot. S–3XL.",
  },
  {
    id: "merch-tumbler",
    type: "direct",
    name: "\"Coffee. Diesel. Repeat.\" 20oz Insulated Tumbler",
    price: 32.99,
    category: "Merch",
    emoji: "🥤",
    badge: "Driver Pick",
    desc: "Stainless double-wall tumbler that keeps truck-stop coffee hot from pre-trip to the first weigh station. Fits standard cup holders.",
  },
  {
    id: "merch-mug",
    type: "direct",
    ...
    category: "Merch",
    emoji: "☕",
    desc: "Big 15 oz ceramic mug, dishwasher safe. Ships to the house so it's waiting after your reset. The go-to gift for the driver in the family.",
  },
  {
    id: "merch-decal",
    type: "direct",
    ...
    category: "Merch",
    emoji: "🐾",
    desc: "Weatherproof vinyl, 5-year outdoor rating. One for the cab, one for the toolbox. Cheapest way to rep the channel.",
  },
